...
function (_React$Component) {
  ...
  _createClass(ResizePanel, [{
    ...
    value: function validateSize() {
      ...
      var actualContent = content.children[0];
      var containerParent = wrapper.parentElement; // Or if our size doesn't equal the actual content size, then we
    ...
    value: function render() {
      ...
      if (this.state.size !== 0) {
        ...
        containerStyle.flexGrow = 0; // containerStyle.overflow = "hidden";
      }

      var handleClasses = this.props.removeHandle ? "" : this.props.handleClass || cx({
      ...
      var handle =
      /*#__PURE__*/
      React.createElement(DraggableCore, _extends({
        key: "handle"
      }, dragHandlers),
      /*#__PURE__*/
      React.createElement("div", {
